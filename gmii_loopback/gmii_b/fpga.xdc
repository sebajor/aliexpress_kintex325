...
set_property -dict {LOC D8 IOSTANDARD LVCMOS25 SLEW FAST DRIVE 16} [get_ports b_phy_gtx_clk]

#set_property -dict {LOC C9 IOSTANDARD LVCMOS25} [get_ports b_phy_tx_clk] 
...
#create_clock -period 40.000 -name phy_tx_clk [get_ports b_phy_tx_clk]
